...
from cail.network import StateIndependentPolicy, TwinnedStateActionFunction
...
class BC(Algorithm):
    ...
    def update(self, writer: SummaryWriter,plot_dir):
        """
        ...
        states, actions, next_states,_,reward = sample_from_dataset(self.buffer_exp,self.batch_size,self.device)
